...
class TestNeighbour(TestCase):
    def setUp(self):
        self.new_hood=NeighborHood(name="Nowhere",location="CNN",popupationCount=80)
        self.new_business=Business(businessesName='Courage Cakes',user=User(1),neighborhood=NeighborHood(1),email='@gmail.com')
        self.new_user=User(username='poteee')
        self.new_post=Post(image='img.png',post='liked',user=User(1),neighborhood=NeighborHood(0))
    def test_initialization(self):
        self.assertTrue(self.new_hood.name,'Nowhere')
        self.assertTrue(self.new_hood.location,'Nowhere')
        self.assertTrue(self.new_hood.occupationCount,80)
    ...
    def test_initialize(self):
        self.assertEqual(self.new_business.businessesName,'Courage Cakes')
